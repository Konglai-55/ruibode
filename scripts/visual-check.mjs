...
for (const profile of [
  ...
  const homeInfo = await page.evaluate(() => {
    ...
    return {
      ...
      logoSlideMode: document.querySelector('.home-hero')?.classList.contains('is-logo-slide-active'),
